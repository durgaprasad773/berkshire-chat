...
export function EmailFormModal({ isOpen, onClose, chatbotId, brandColour }) {
  ...
  return (
    <dialog
      ...
      className="rounded-2xl shadow-2xl max-w-md w-full max-h-[80vh] overflow-y-auto p-0 backdrop:bg-slate-900/50"
    >
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-5">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-slate-200 rounded-xl text-[14px] resize-none focus:outline-none focus:border-slate-400 transition min-h-24"
              required
            />
          </div>
